...
def main(fps = 60, duration = 0.35):
    ...
    df = DataHandler.DataHandler(excel_file="cof.xlsx", number_of_frames=number_of_frames).df
    ...
    # add static text
    canvas.add_title("Cumulative CO2 Emissions", color=(0,132,255))
    canvas.add_sub_title("(Metric tons per capita)", color=(0,132,255))
